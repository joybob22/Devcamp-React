...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: 'https://braydenlemke.devcamp.space/portfolio/portfolio_items',
            apiAction: 'post'
        }
    ...
    componentDidUpdate() {
        if(Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://braydenlemke.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: 'patch',
    ...
    handleSubmit(event) {
        axios({
            ...
            .catch(err => {
                console.log('ERROR in porfolio form handle submit', err);
            })
