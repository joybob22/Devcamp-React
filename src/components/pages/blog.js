...
class Blog extends Component {
    ...
    handleDeleteClick(blog) {
        axios.delete(`https://api.devcamp.space/portfolio/portfolio_blogs/${blog.id}`, {withCredentials: true})
            .then(res => {
                ...
                console.log("error in handleDeleteClick in blog", err);
            })
    }
    ...
    getBlogItems() {
        ...
        axios.get(`https://braydenlemke.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {withCredentials: true})
            .then(res => {
