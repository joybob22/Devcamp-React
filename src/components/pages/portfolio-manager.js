...
export default class PortfolioManager extends Component {
    ...
    getPortfolioItems() {
        axios.get('https://braydenlemke.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc', {withCredentials: true})
            .then(res => {
                this.setState({
                    portfolioItems: [...res.data.portfolio_items]
                })
            }).catch(err => {
                console.log("err in getting portfolio item in portfolio manager", err);
            })
    }
